...
let Img;
    ...
    return(
        <div className="Weather_Item">
         <div className={item.Color?"Weather_Item_Header Header_Black":"Weather_Item_Header Header_White"}>
         <h3>{item.dt_txt.split(' ')[1]}</h3>
         </div>
         <div className={item.Color?"Weather_Item_Main Main_Black":'Weather_Item_Main Main_White'}>
